...
//takes an array value, and a numeric value
...
//function takes array and function parameters
...
*   2) a function
* Objectives:
*   1) call func for each element in <collection> passing the arguments:
*        if <collection> is an array:
*            the element, it's index, <collection>
*        if <collection> is an object:
...
//takes a collection and an func 
...
//takes collection and a function
...
//takes unlimited object properties
